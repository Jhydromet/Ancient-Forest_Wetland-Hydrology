...
setwd("E:/Jeremy's MSc Research/Chemistry Data and Analysis/Geochemistry")
library(tidyverse)
library(plotly)
library(lubridate)
library(scales)
...
dat <- read_csv("Isotope2020Tidy.csv") %>%
...
stndat <- read_csv("E:/Jeremy's MSc Research/Hydrometric and GIS/Climate Data/AF_Station.csv")
