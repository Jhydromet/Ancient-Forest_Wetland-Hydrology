...
setwd("E:\\Jeremy's MSc Research\\Hydrometric and GIS\\Water Data\\Groundwater\\Raw\\Pumping Data")

file <- dir(pattern = "*.csv")

TidyDat <- function(file) {
...
# Calibrate the data
cal <- read_csv("E:\\Jeremy's MSc Research\\Hydrometric and GIS\\Water Data\\Groundwater\\For Analysis\\Calibration Values.csv") %>% 
